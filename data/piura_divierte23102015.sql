...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-10-2015 a las 22:28:38
...
CREATE TABLE IF NOT EXISTS `evento` (
  ...
  `horra_fin` time DEFAULT NULL,
  `descripcion` varchar(45) NOT NULL,
  `privacy` tinyint(1) DEFAULT NULL,
  `logo` blob,
  `url` text,
  `fecha_creacon` datetime DEFAULT NULL,
  `capacidad` int(11) DEFAULT NULL,
  `compartible` tinyint(1) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `evento_has_usuario_has_persona`
--

CREATE TABLE IF NOT EXISTS `evento_has_usuario_has_persona` (
  `evento_has_usuario_evento_idevento` int(11) NOT NULL,
  `evento_has_usuario_usuario_idusuario` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `persona` (
  ...
  `nonbres` varchar(45) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `usuario_nivel_idusuario_nivel` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `usuario_nivel` (
  `idusuario_nivel` int(11) NOT NULL,
  `descripcion` varchar(45) NOT NULL,
...
ALTER TABLE `distrito`
  ADD PRIMARY KEY (`idDist`,`idProv`);

--
-- Indices de la tabla `evento`
--
ALTER TABLE `evento`
  ADD PRIMARY KEY (`idevento`,`lugar_idlugar`,`SubCategoria_idSubCategoria`,`SubCategoria_Categoria_idCategoria`);

--
-- Indices de la tabla `evento_has_usuario`
--
ALTER TABLE `evento_has_usuario`
  ADD PRIMARY KEY (`evento_idevento`,`usuario_idusuario`);

--
-- Indices de la tabla `evento_has_usuario_has_persona`
--
ALTER TABLE `evento_has_usuario_has_persona`
  ADD PRIMARY KEY (`evento_has_usuario_evento_idevento`,`evento_has_usuario_usuario_idusuario`,`Persona_idPersona`);
...
--
ALTER TABLE `lugar`
  ADD PRIMARY KEY (`idlugar`,`idDist`,`idProv`);
...
ALTER TABLE `usuario_nivel`
  ADD PRIMARY KEY (`idusuario_nivel`);
...
--
ALTER TABLE `distrito`
  MODIFY `idDist` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=1832;
--
...
--
ALTER TABLE `provincia`
  MODIFY `idProv` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=194;
--
...
--
ALTER TABLE `usuario_nivel`
  MODIFY `idusuario_nivel` int(11) NOT NULL AUTO_INCREMENT;
